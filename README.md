...
Figures like the following can be generated by exporting solutions as `.vtk` files and plotting using a tool such as [Visit](https://visit-dav.github.io/visit-website/index.html)
